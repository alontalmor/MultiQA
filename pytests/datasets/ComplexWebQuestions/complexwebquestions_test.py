...
from datasets.ComplexWebQuestions.complexwebquestions import ComplexWebQuestions
from common.preprocess import MultiQAPreProcess


class TestComplexWebQuestionsDataset:
    ...
    def test_build_contexts(self, split):
        ...
        dataset = ComplexWebQuestions(preprocessor, split, dataset_version, dataset_flavor, dataset_specific_props, \
