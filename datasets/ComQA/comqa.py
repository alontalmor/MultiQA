...
class ComQA(MultiQA_DataSet):
    ...
    def build_header(self, contexts):
        header = {
            ...
            "split": self._split,
            "dataset_url": "http://qa.mpi-inf.mpg.de/comqa",
            "license": "",
            "data_source": "WikiAnswers",
    ...
    def build_contexts(self):
        single_file_path = cached_path("https://multiqa.s3.amazonaws.com/raw_datasets/ComQA/ComQA2_" + self._split + ".jsonl.zip")
