...
class ComplexQuestions(MultiQA_DataSet):
    """
    ...
    def __init__(self, preprocessor, split, dataset_version, dataset_flavor, dataset_specific_props, \
        ...
        self.DATASET_NAME = 'ComplexQuestions'
    ...
    def build_header(self, contexts):
        header = {
            ...
            "split": self._split,
            "dataset_url": "https://github.com/JunweiBao/MulCQA/tree/ComplexQuestions",
            "license": "",
            "data_source": "Web queries/KB",
    ...
    def build_contexts(self):
        single_file_path = cached_path("https://multiqa.s3.amazonaws.com/raw_datasets/ComplexQuestions/ComplexQuestions2_" + self._split + ".jsonl.zip")
